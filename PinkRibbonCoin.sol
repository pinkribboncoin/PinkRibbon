...
contract PinkRibbonCoin is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 62692969420 * 10*9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name     = "Pink Ribbon Coin";
    ...
    uint256 public _maxTxAmount                   = 62692969420 * 10**9;
